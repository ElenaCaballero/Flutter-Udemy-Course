...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _saveForm() {
    ...
    if (_editedProduct.id != null) {
      Provider.of<Products>(this.context, listen: false).updateProduct(_editedProduct.id, _editedProduct);
    } else {
      Provider.of<Products>(this.context, listen: false).addProduct(_editedProduct);
    }
